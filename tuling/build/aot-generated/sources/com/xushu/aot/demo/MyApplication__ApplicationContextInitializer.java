...
public class MyApplication__ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  ...
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new MyApplication__BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new MyApplication__BeanFactoryRegistrations().registerAliases(beanFactory);
  }
}
