 ...
 * @Slogan 致敬大师，致敬未来的你
 */
public class MyInstantiationModelAwarePointcutAdvisorImpl implements InstantiationModelAwarePointcutAdvisor, AspectJPrecedenceInformation, Serializable {
    ...
    public MyInstantiationModelAwarePointcutAdvisorImpl(AspectJExpressionPointcut declaredPointcut,
        ...
        if (aspectInstanceFactory.getAspectMetadata().isLazilyInstantiated()) {
            ...
            this.pointcut = new MyInstantiationModelAwarePointcutAdvisorImpl.PerTargetInstantiationModelPointcut(
